...
INSERT INTO knowledge_definition (file_path, file_name, category, version, description) VALUES
    ...
    ('tasks/brand_onboarding.yaml', 'brand_onboarding.yaml', 'tasks', '1.0.0', '品牌导入任务模板'),
    ...
    ('policies/claim_policy.yaml', 'claim_policy.yaml', 'policies', '1.0.0', '事实与主张策略'),
    ('policies/conflict_policy.yaml', 'conflict_policy.yaml', 'policies', '1.0.0', '冲突处理策略'),
    ('policies/context_policy.yaml', 'context_policy.yaml', 'policies', '1.0.0', '上下文检索策略'),
    ('examples/positive_examples.yaml', 'positive_examples.yaml', 'examples', '1.0.0', '25 组正确示例'),
