...
Usage:
    python -m engine.neo4j.projection --init            # apply cypher_init.cypher
    python -m engine.neo4j.projection --full            # full resync from PG
    python -m engine.neo4j.projection --process-outbox  # incremental from outbox
    python -m engine.neo4j.projection --check           # connectivity check
"""
