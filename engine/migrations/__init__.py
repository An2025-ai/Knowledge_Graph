...
Usage:
    python -m engine.migrations migrate            # run all (L1 → L2/L3)
    python -m engine.migrations migrate --only l2_l3  # run only one layer
"""
...
def main() -> int:
    ...
    from engine.core import db as dbmod
