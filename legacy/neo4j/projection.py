...
Usage:
    python -m legacy.neo4j.projection --init            # apply cypher_init.cypher
    python -m legacy.neo4j.projection --full            # full resync from PG
    python -m legacy.neo4j.projection --process-outbox  # incremental from outbox
    python -m legacy.neo4j.projection --check           # connectivity check
"""
