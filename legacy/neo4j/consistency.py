...
Usage:
    python -m legacy.neo4j.consistency        # full counts comparison + orphan check
    python -m legacy.neo4j.consistency --sample 5  # plus sample assertion spot-check
"""
...
def main() -> int:
    ...
    from legacy.neo4j import projection
