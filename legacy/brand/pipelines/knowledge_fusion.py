...
复用 ``legacy.fusion.fusion_service``（确定性基线）。tenant 来自品牌上下文（resolve_brand_context
保证 L3 RLS 可见）。
"""
...
from legacy.brand.pipelines._helpers import resolve_brand_context
from legacy.fusion.fusion_service import run_fusion
