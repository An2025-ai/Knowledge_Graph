...
Usage:
    python -m legacy.industry.executor --pipeline candidate_extraction --document-id <id>
    python -m legacy.industry.executor --all --text "<正文>" [--dry-run]
    python -m legacy.industry.executor --all --file <doc.md> [--dry-run]
...
from legacy.core.db import check_connection, DB


# Map of pipeline name -> (module import path, run function).
PIPELINES = {
    "article_registration": "legacy.industry.pipelines.article_registration",
    "content_parsing": "legacy.industry.pipelines.content_parsing",
    "evidence_unit_merge": "legacy.industry.pipelines.evidence_unit_merge",
    "candidate_extraction": "legacy.industry.pipelines.candidate_extraction",
    "candidate_normalization": "legacy.industry.pipelines.candidate_normalization",
    "candidate_vectorization": "legacy.industry.pipelines.candidate_vectorization",
    "knowledge_fusion": "legacy.industry.pipelines.knowledge_fusion",
    "promotion": "legacy.industry.pipelines.promotion",
}
