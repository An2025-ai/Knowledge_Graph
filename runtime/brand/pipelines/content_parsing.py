...
复用共享 ``runtime.extraction.evidence_parsing``（与 L2 content_parsing 同一套证据层机械，但流程独立）。
"""
...
from runtime.extraction.evidence_parsing import parse_to_span_rows, write_spans
from runtime.core.knowledge_service import document_provenance
