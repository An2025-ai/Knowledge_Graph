...
Usage:
    python -m runtime.industry.scope_builder --industry "CRM软件" --market CN \
...
from runtime.common.registry import get_common_registry  # noqa: E402

_SOURCE_POLICY = get_common_registry()
