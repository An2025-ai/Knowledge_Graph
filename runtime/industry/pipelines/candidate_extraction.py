...
from runtime.extraction.candidate_extraction import pre_extract, build_candidate_rows
from runtime.core.knowledge_service import (
    document_provenance,
...
def run(db: DB, args) -> dict[str, Any]:
    ...
    if ner_enabled:
        try:
            from runtime.clients.ner_client import get_ner_client
