...
from runtime.industry.scope_builder import DIMENSION_TEMPLATE
from runtime.industry.search.providers import (
...
DIMENSION_SOURCE_CLASSES = {
    code: get_common_registry().dimension_source_classes(code)
    for code in (
...
DEFAULT_TRUSTED_DOMAINS = {
    "CN": get_common_registry().trusted_domains("CN"),
    "GLOBAL": get_common_registry().trusted_domains("GLOBAL"),
}
