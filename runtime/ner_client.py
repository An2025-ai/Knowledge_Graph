...
This module mirrors the provider-abstraction pattern of ``runtime/embeddings.py``
...
Config section (runtime/config/model-config.local.json):
...
# candidate_type values in ``extraction_candidate``; see _TYPE_ALIASES below.
